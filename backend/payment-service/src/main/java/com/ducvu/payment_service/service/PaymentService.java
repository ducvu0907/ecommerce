...
public class PaymentService {
    ...
    public PaymentResponse getPaymentByOrderId(String token, String orderId, HttpServletRequest httpServletRequest) {
        ...
        var vnpayTransaction = getVNPayTransaction(payment.getTransactionRef(), payment.getOrderId(), ipAddr);
    ...
    private VNPayResponse getVNPayTransaction(String txnRef, String orderInfo, String ipAddr) {
        var req = vnPayService.queryTransaction(txnRef, orderInfo, ipAddr);
