...
public interface PaymentClient {
    ...
    ApiResponse<?> createPayment(@RequestBody CreatePaymentRequest request);

    @DeleteMapping(value = "/payments/order/{orderId}", consumes = "application/json")
    ApiResponse<?> deletePayment(@PathVariable Integer orderId, @RequestBody AuthRequest request);
}
